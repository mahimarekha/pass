                        ...
                        >
                            ...
                            <div>
                                ...
                                <Dialog open={open} onClose={handleClose}>
                                    <DialogTitle>legaslature Party office</DialogTitle>
                                            ...
                                            {/* <Grid xs={12} md={12}>
                                                ...
                                                <Grid xs={12} md={12}>
                                                    <TextField
                                                        ...
                                                        id="MinisterName"
                                                        name="MinisterName"
                                                        label="Leguslative Party Office Name"
                                                        type="text"
                                                        variant="standard"
                                                        onChange={formik.handleChange}
